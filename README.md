...
- Weekly reports now add structural judgement summaries for `Clarity`, `Context Provision`, `Procedure Design`, `Verifiability`, and `Recovery` while preserving the original six-axis table.

## Latest Update

- `2026-07-03`: [Outcome-first evaluation criteria](./docs/feature-updates/2026-07-03.md)
...
- Weekly reports also include a structural summary table for the enabled axes and show grade adjustments when structural rules trigger.
