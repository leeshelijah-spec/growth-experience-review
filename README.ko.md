...
- 주간 리포트는 이제 `명확성`, `맥락 제공력`, `절차 설계력`, `검증성`, `복구력`에 대해 구조 판정 요약을 추가하면서도 기존 6축 표 형식은 유지합니다.

## 최신 업데이트

- `2026-07-03`: [결과 중심 평가기준 전환](./docs/feature-updates/2026-07-03.md)
...
- 리포트에 구조 판정 요약 표가 추가되고, 구조 규칙이 발동하면 보정 결과가 함께 표시되는지
